...
async def start(bot, update):
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚙ Channel ⚙', url='https://t.me/YouTech_VPN_HUB'), InlineKeyboardButton('⚙ Group ⚙', url='https://t.me/YouTech_Support')]]),
...
async def getmedia(bot, update):
    ...
    await text.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Open Link", url=f"https://telegra.ph{response[0]}"), InlineKeyboardButton(text="Share Link", url=f"https://telegram.me/share/url?url=https://telegra.ph{response[0]}"),],
                                           [InlineKeyboardButton(text="⚙ Join Updates Channel ⚙", url="https://t.me/YouTech_VPN_HUB")]])
    )
    try:
        os.remove(medianame)
    except:
